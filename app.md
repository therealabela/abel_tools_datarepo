...
(function () {
    ...
    var META = {
        ...
        'savemybattery v2.2': { icon: 'batteryBolt', gradient: 'linear-gradient(135deg,#5a90f8,#0a84ff)', category: 'Battery', desc: 'The newest SaveMyBattery. Squeeze more out of every charge in one tap, with the latest tweaks for iOS 26.', link: 'https://www.icloud.com/shortcuts/c271c9c9859e4ab2b69234e5d04897f7' },
    ...
    var FALLBACK_LIST = [
        ...
        'SaveMyBattery V2.2', 'SaveMyBattery V2.1', 'SaveMyBattery V1',
